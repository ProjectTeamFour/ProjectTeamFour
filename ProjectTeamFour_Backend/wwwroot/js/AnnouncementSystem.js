const announcement = new Vue({
    ...
    methods: {
        ...
        clearModel() {
            ...
            axios.get("/Api/SystemAnnouncements/GetAll")
                .then((res) => {
        ...
        saveAnnouncement() {
            axios.put("/Api/SystemAnnouncements/SystemSaveAnnouncement", this.Model)
                .then(res => {
                    console.log(res);
        ...
        createAnnouncement() {
            axios.post("/Api/SystemAnnouncements/CreateSystemAnnouncement", this.Model)
                .then(res => {
                    console.log(res);
